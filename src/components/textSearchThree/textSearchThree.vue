          ...
          <el-form :model="dengmiQueryForm" label-position="left" ref="dengmiQueryForm" class="demo-ruleForm" size="mini">
            ...
            <el-row>
              ...
              <el-col :span="8">
                ...
                <el-input v-model="zdIpt.txt" @blur="inptZdYear" style="float:right;width:20%" placeholder="请输入制度文号"></el-input>
                <el-input v-model="zdIpt1.txt" @blur="inptZdNo" style="float:right;width:20%" placeholder="请输入制度文号"></el-input>
              </el-col>
              <el-col :span="8">
                <el-form-item label="">
                </el-form-item>
