<template>
<el-container id="dfEdit" class="container">
    ...
    <!--拆分导入-->
    <div class="section-rowdccs" id="dfEdits" v-if="tableShow">
...
<style lang="scss">
#dfEdits .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell {
...
#dfEdits .el-table__body-wrapper /deep/ tr td {
    text-align: center;
    text-indent: 0;
    border-right: none !important;
}

#dfEdits .el-table__header /deep/ th {
    border-right: none !important;
}

#dfEdits .el-table__header /deep/ th>.cell {
    text-align: center;
    float: left;
    text-indent: 0;
}
