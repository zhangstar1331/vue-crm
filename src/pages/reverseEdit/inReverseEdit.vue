<template>
	<el-container id="inEdit" class="container">
		...
		<div class="render mbtm20">
			<div class="box" style="min-height: 200px;padding-bottom: 16px;">
				<!--tittle-->
				<el-row>
					<el-col :span="12">
		...
		<!--拆分导入-->
		<div class="section-rowdccs" id="inEdits" v-if="tableShow">
			<div class="section-dealise">
				<div class="titIcon">
					...
					<el-button class="standardBtn" type="primary" v-if="downLoadBtn" @click="downLoadTemplate">下载模板</el-button>
...
export default {
	...
	methods: {
		...
		getFileType(index, row) {
			...
			console.log(saveDatas.fileFlag)
			sessionStorage.setItem('saveDatas', JSON.stringify(saveDatas))
		},
		//上传模板文件
...
<style lang="scss">
#inEdits .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell {
	white-space: pre-line !important;
	text-indent: 0 !important;
	text-align: left !important;
	padding-left: 5%;
}
#inEdits .el-table__body-wrapper /deep/ tr td {
	text-align: center;
	text-indent: 0;
	border-right: none !important;
}
#inEdits .el-table__header /deep/ th {
	border-right: none !important;
}
#inEdits .el-table__header /deep/ th>.cell {
	text-align: center;
	float: left;
	text-indent: 0;
}
