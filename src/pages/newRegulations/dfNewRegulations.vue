<template>
<el-container id="dfBuid" class="container">
        ...
        <el-row>
            <el-col :span="12">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item class="txtColor">新增东方制度</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
        ...
        <div class="box">
            ...
            <el-table :data="tableData" style="width: 100%;border: 1px solid #E9E9E9;">
                ...
                <el-table-column prop="address" label="文件类型">
                    <template slot-scope="scope">
                        <!--<el-radio v-model="scope.row.radio" @change="getFileType1(scope.$index,scope.row)"  :value="1" :label="1">制度</el-radio>

<el-radio v-model="scope.row.radio" @change="getFileType1(scope.$index,scope.row)"  :value="0" :label="0">附件</el-radio>-->
                        <el-radio-group v-model="scope.row.radio">
                            <template v-for="(item, index) in status_arr">
                                <el-radio @change="getFileType1(scope.$index,scope.row)" :label="item.code">{{item.text}}</el-radio>
                            </template>
                        </el-radio-group>
                    </template>
                </el-table-column>
    ...
    <!--拆分导入-->
    <div class="section-rowdccs" id="dfNewbu" v-if="tableShow">
...
#dfNewbu .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell {
...
#dfNewbu .el-table__body-wrapper /deep/ tr td {
    text-align: center;
    text-indent: 0;
    border-right: none !important;
}

#dfNewbu .el-table__header /deep/ th {
    border-right: none !important;
}

#dfNewbu .el-table__header /deep/ th>.cell {
    text-align: center;
    float: left;
    text-indent: 0;
}
