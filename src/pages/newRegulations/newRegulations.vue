<template>
  <el-container id="newBuid" class="container">
  	...
  	<el-row>
	  	<el-col :span="12">
		  	<el-breadcrumb separator-class="el-icon-arrow-right">
				  ...
				  <el-breadcrumb-item :to="{ path: '/repository/out-manage',query:{'id':'1_couter'}}">外规管理</el-breadcrumb-item>
				  <el-breadcrumb-item class="txtColor">新增外规</el-breadcrumb-item>
				</el-breadcrumb>
			</el-col>
	...
	<!--相关文件-->
		<div class="render mbtm20">
			<div class="box">
				...
				<el-row>
					<el-col :span="12">
						<div class="titIcon fontWeight"><em></em><span>相关文件</span></div>
					</el-col>
					<el-col :span="12" align="right">
  ...
  <!--拆分导入-->
	<div class="section-rowdccs" id="newBuu" v-if="tableShow">
		<div class="section-dealise">
			<div class="titIcon">
				...
				<el-button class="standardBtn" type="primary" style="margin-right: 0;" v-if="downLoadBtn" @click="downLoadTemplate">下载模板</el-button>
		...
		<el-pagination style="text-align: center;margin-top: 16px;" :current-page.sync="currentPage" @size-change="handleSizeChange" @current-change="handleCurrentChange" background layout="prev, pager, next" prev-text="上一页" next-text="下一页" :total="total" ></el-pagination>
	</div>
  </el-container>
</template>
<script>
...
//  		sessionStorage.instId=''
    ...
    methods:{
      ...
      submitReturn(){
        this.$router.push({
          path:'/repository/out-manage',   //跳转的路径
...
<style lang="scss">
	...
	#newBuu .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell{
		white-space:pre-line!important;
		text-indent:0!important;
		text-align: left!important;
		padding-left: 5%;
	}
	#newBuu .el-table__body-wrapper /deep/ tr td{
		text-align: center;
		text-indent: 0;
		border-right: none!important;
	}
	#newBuu .el-table__header /deep/ th{
		border-right: none!important;
	}
	#newBuu .el-table__header /deep/ th>.cell{
		text-align: center;
		float: left;
		text-indent: 0;
	}
