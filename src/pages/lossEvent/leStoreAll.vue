<template>
    <div id="leStoreAall">
      ...
      <el-breadcrumb-item :to="{path:'/lossEvent/lossEventStore?id=1_lsjk'}"><span style="color: #909191;font-weight: 700">{{titMsg}}</span></el-breadcrumb-item>
      <el-breadcrumb-item class="txtColor">损失事件</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="box">
