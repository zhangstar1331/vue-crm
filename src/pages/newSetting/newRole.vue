<template>
  <div class="editRole">
  	<el-breadcrumb separator-class="el-icon-arrow-right">
		...
		<el-breadcrumb-item class="txtColor">新增角色</el-breadcrumb-item>
  	</el-breadcrumb>
  	<div class="setBox">
  		<div class="titIcon"><em></em><span style="font-weight: 600;">新增角色</span></div>
  			...
  			this.$refs[formName].validate(valid => {
		        if (valid) {
		        	if(this.roleForm.roletype == ''){
		  			...
		  			this.axios.post('rmUser/addRole',params).then((res)=>{
			            if(res.code == 200){
			          		if(res.data == true){
...
<style>
	...
	.editRole-form .el-form-item__content{
		width:300px!important;
	}
	.editRole-form .el-textarea{
		width: 300px;
	}
