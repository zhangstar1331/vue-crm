<template>
  <div id="inCont">
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top:13px">
      ...
      <el-breadcrumb-item class='separator-ic'>{{detailName}}</el-breadcrumb-item>
    ...
    <div class="sister-title">
      ...
      <el-row>
        <el-col :span="8" style="padding-left:10px">
          <div class="grid-content bg-purple">
            <el-form :model="dynamicValidateForm" ref="dynamicValidateForm"  class="demo-dynamic">
              <el-form-item label="公司管理类别：" required style="text-align: left;">
                <span>{{riskLevel}}</span>
              </el-form-item>
              <el-form-item label="发布日期：" prop="startDate" required>
                <span>{{issuedDates}}</span>
              </el-form-item>
              <el-form-item class="nameCss" label="风险类别：" prop="region" required>
                <span>{{name}}</span>
              </el-form-item>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form  :model="dynamicValidateForm" ref="dynamicValidateForm" class="demo-dynamic">
              ...
              <el-form-item label="适用范围：" class="nameCss" required style="text-align: left;">
                <span>{{placeName}}</span>
              </el-form-item>
            </el-form>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form  :model="dynamicValidateForm" ref="dynamicValidateForm" class="demo-dynamic">
              <el-form-item label="所属部门：" required  prop="name" style="text-align: left;">
                <span>{{departmentName}}</span>
              </el-form-item>
              <el-form-item label="有效期限："  required style="text-align: left;">
                <span>{{endDate}}</span>
              </el-form-item>
              <el-form-item label="制度名称：" class="nameCss" required style="text-align: left;">
                <span>{{name}}</span>
              </el-form-item>
            </el-form>
          </div>
      ...
      init(id){
        this.axios.post('/instweb/detail',
          ...
          if(res.code == 200){
            ...
            //管理类别
            if(res.data.manageCategory==1){
              this.riskLevel='公司治理类'
            }else if(res.data.manageCategory==2){
              this.riskLevel='行政管理类'
            }else if(res.data.manageCategory==3){
              this.riskLevel='人力资源管理类'
            }else if(res.data.manageCategory==4){
              this.riskLevel='财务管理类'
            }else if(res.data.manageCategory==11){
              this.riskLevel='其他类'
            }else if(res.data.manageCategory==5){
              this.riskLevel='战略管理类'
            }else if(res.data.manageCategory==6){
              this.riskLevel='资金运用类'
            }else if(res.data.manageCategory==7){
              this.riskLevel=='风险管理类'
            }else if(res.data.manageCategory==8){
              this.riskLevel='合规法务类'
            }else if(res.data.manageCategory==9){
              this.riskLevel='稽核审计类'
            }else if(res.data.manageCategory==10){
              this.riskLevel='监察类'
            }
