<template>
<el-container id="inContainer" class="container">
        ...
        <el-row>
            <el-col :span="12">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item :to="{ path: '/repository/in-manage',query:{'id':'1_cinner'}}">内部制度管理</el-breadcrumb-item>
    ...
    <!--拆分导入-->
    <div class="section-rowdccs" id="inRever" v-if="tableShow">
...
export default {
    ...
    methods: {
        loadFile(index, row) {
            ...
            this.axios.post('comm/download/101', qs.stringify(obj), {
...
<style lang="scss">
#inRever .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell {
...
#inRever .el-table__body-wrapper /deep/ tr td {
    text-align: center;
    text-indent: 0;
    border-right: none !important;
}

#inRever .el-table__header /deep/ th {
    border-right: none !important;
}

#inRever .el-table__header /deep/ th>.cell {
    text-align: center;
    float: left;
    text-indent: 0;
}
