...
<el-container class="container">
    ...
    <!--拆分导入-->
    <div class="section-rowdccs" id="reserveCont" v-if="tableShow">
...
export default {
    ...
    methods: {
        loadFile(index, row) {
            ...
            this.axios.post('comm/download/102', qs.stringify(obj), {
...
<style lang="scss">
#reserveCont .el-table__body-wrapper /deep/ tr td:nth-child(3)>.cell {
...
#reserveCont .el-table__body-wrapper /deep/ tr td {
    text-align: center;
    text-indent: 0;
    border-right: none !important;
}

#reserveCont .el-table__header /deep/ th {
    border-right: none !important;
}

#reserveCont .el-table__header /deep/ th>.cell {
    text-align: center;
    float: left;
    text-indent: 0;
}
